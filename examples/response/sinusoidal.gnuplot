...
set y2label "Pressure coefficient\nfrom frequency response" tc "white" offset graph 0.105
...
set ytics -1,0.1,1.
set pm3d noborder
splot "< gzip -dc Ma0p5.gz" u 1:2:(sinusoidal($3, $4, $5)) with polygons palette
...
set samples 1000
plot sample \
    [0:1] naca(x) lc "white" lw 1, \
    [0:1] -naca(x) lc "white" lw 1, \
    [0:1] naca(x) - x * sin(pitch) lc "magenta" lt 0 lw 2, \
    [0:1] -naca(x) - x * sin(pitch) lc "magenta" lt 0 lw 2
